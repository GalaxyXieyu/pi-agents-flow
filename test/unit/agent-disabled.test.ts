...
describe("builtin agent disabling", () => {
	beforeEach(() => {
		tempHome = fs.mkdtempSync(path.join(os.tmpdir(), "pi-agents-flow-disabled-home-"));
		tempProject = fs.mkdtempSync(path.join(os.tmpdir(), "pi-agents-flow-disabled-project-"));
