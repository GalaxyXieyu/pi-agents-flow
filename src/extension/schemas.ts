...
const SubagentParamsSchema = Type.Object({
	...
	timeoutMs: Type.Optional(Type.Integer({ minimum: 1, description: "Explicit timeout for foreground and async/background runs; omitted means no runtime deadline absent an agent default. Alias maxRuntimeMs." })),
	maxRuntimeMs: Type.Optional(Type.Integer({ minimum: 1, description: "Alias timeoutMs for foreground and async/background runs; omitted means no runtime deadline absent an agent default." })),
