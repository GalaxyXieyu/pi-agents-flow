...
When syncing upstream, compare public delegation and preflight contracts first. Do not overwrite `src/workflows/`, persisted `.pi-agents-flow` formats, or fork-specific Agent policy without an explicit migration and regression tests.
